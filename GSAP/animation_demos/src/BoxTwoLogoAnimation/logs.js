...
import { TimelineMax, Elastic, Back, Sine } from "gsap/gsap-core";
		...
		return (
			<svg xmlns='http://www.w3.org/2000/svg' width={this.props.width} height={this.props.height} viewBox='0 0 245 245' className='mmt-logo' preserveAspectRatio='xMidYMid meet'>
				...
				<g ref={(b) => (this.letters = b)} id='letters' fill={this.props.text}>
					...
					<path
						id='n'
						d='M119.53 187.51h-.58a.31.31 0 0 0-.31.31v8.78l-7.43-9.26h-.41a.31.31 0 0 0-.31.3v11.08a.32.32 0 0 0 .31.31h.58a.31.31 0 0 0 .31-.31v-9l7.56 9.44h.3a.31.31 0 0 0 .31-.3v-11.03a.32.32 0 0 0-.33-.32z'
					/>
					<path
						id='h'
						d='M106.76 187.51h-.64a.31.31 0 0 0-.31.31v4.81h-6.69v-4.81a.31.31 0 0 0-.31-.31h-.64a.32.32 0 0 0-.31.31v10.9a.32.32 0 0 0 .31.31h.64a.31.31 0 0 0 .31-.31v-5h6.69v5a.31.31 0 0 0 .31.31h.64a.32.32 0 0 0 .31-.31v-10.89a.32.32 0 0 0-.31-.32z'
					/>
					<path
						id='c'
						d='M94.83 196.72a.31.31 0 0 0-.4 0 4.69 4.69 0 1 1-3.15-8.24 5 5 0 0 1 3.15 1.24c.16.17.3.18.43 0l.44-.45a.32.32 0 0 0 0-.45 5.79 5.79 0 0 0-4-1.53 5.93 5.93 0 1 0 0 11.86 5.65 5.65 0 0 0 4-1.6.31.31 0 0 0 0-.44z'
					/>
					<path
						id='e'
						d='M83.29 187.51h-6.5a.31.31 0 0 0-.31.31v10.9a.31.31 0 0 0 .31.31h6.49a.31.31 0 0 0 .31-.31v-.48a.31.31 0 0 0-.31-.31h-5.54v-4.21h4.73a.31.31 0 0 0 .31-.31v-.48a.33.33 0 0 0-.31-.31h-4.73v-4h5.54a.31.31 0 0 0 .31-.31v-.48a.31.31 0 0 0-.31-.31z'
					/>
					<path
						id='t'
						d='M74.35 187.51h-7a.31.31 0 0 0-.31.31v.48a.31.31 0 0 0 .31.31h2.87v10.11a.32.32 0 0 0 .31.31h.63a.32.32 0 0 0 .31-.31v-10.1h2.87a.31.31 0 0 0 .31-.31v-.48a.31.31 0 0 0-.31-.32z'
					/>
					<path
						id='a'
						d='M160.77 180.31h.66a.3.3 0 0 0 .28-.18l1.2-2.72h5.85l1.22 2.72a.3.3 0 0 0 .28.18h.66a.29.29 0 0 0 .28-.43l-5-11.09a.29.29 0 0 0-.28-.18h-.17a.29.29 0 0 0-.28.18l-5 11.09a.29.29 0 0 0 .28.43zm5-9.32h.13c.81 1.8 1.6 3.61 2.41 5.4h-4.94z'
					/>
					...
					<path
						id='e-2'
						d='M142.45 180v-.48a.31.31 0 0 0-.31-.31h-5.54v-4.2h4.73a.31.31 0 0 0 .36-.29v-.48a.32.32 0 0 0-.31-.31h-4.73v-4h5.54a.31.31 0 0 0 .31-.31v-.48a.31.31 0 0 0-.31-.31h-6.5a.31.31 0 0 0-.31.31v10.91a.31.31 0 0 0 .31.31h6.49a.31.31 0 0 0 .31-.31z'
						data-name='e'
					/>
					<path
						id='m'
						d='M123.05 171.59l3.06 8.7a.34.34 0 0 0 .28.18h.3a.33.33 0 0 0 .28-.18l3-8.7h.07l1.47 8.48a.34.34 0 0 0 .3.23h.66c.25 0 .35-.17.3-.4l-2.08-11.06a.32.32 0 0 0-.3-.23h-.26a.31.31 0 0 0-.28.18l-3.21 9.08h-.08l-3.26-9.08a.31.31 0 0 0-.28-.18h-.33a.32.32 0 0 0-.3.23l-2.13 11.07c0 .23 0 .4.3.4h.66a.32.32 0 0 0 .3-.23l1.43-8.48z'
					/>
					<rect id='i-2' width='1.28' height='11.53' x='116.47' y='168.77' data-name='i' rx='.31' ry='.31' />
					<path
						id='t-2'
						d='M111.16 180.31a.32.32 0 0 0 .31-.31v-10.12h2.87a.31.31 0 0 0 .31-.31v-.48a.31.31 0 0 0-.31-.31h-7a.31.31 0 0 0-.31.31v.48a.31.31 0 0 0 .31.31h2.87V180a.32.32 0 0 0 .31.31z'
						data-name='t'
					/>
					...
					<path
						id='m-2'
						d='M85.91 180.31h.66c.25 0 .35-.17.3-.4l-2.13-11.07a.32.32 0 0 0-.3-.23h-.26a.31.31 0 0 0-.28.18l-3.21 9.08h-.08l-3.26-9.08a.31.31 0 0 0-.28-.18h-.26a.32.32 0 0 0-.3.23l-2.12 11.07c0 .23 0 .4.3.4h.66a.32.32 0 0 0 .3-.23l1.43-8.48h.07l3.07 8.7a.33.33 0 0 0 .28.18h.3a.33.33 0 0 0 .28-.18l3-8.7h.07l1.47 8.48a.34.34 0 0 0 .29.23z'
						data-name='m'
					/>
				</g>
